document.addEventListener('DOMContentLoaded', domReady);
            ...
            for (let i = 0; i < imagesLength; i++) {
                ...
                switch (i) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        image.src = image.src + 'segsslam.jpg';
                        break;
                    case 5:
        ...
        function replicageomSceneEvent(idx) {
            ...
            for (let i = 0; i < imagesLength; i++) {
                ...
                switch (idx) {
                    case 0:
                        image.src = 'img/geom/replica/room0/';
                        break;
                    case 1:
                        image.src = 'img/geom/replica/room1/';
                        break;
                    case 2:
                        image.src = 'img/geom/replica/room2/';
                        break;
                    case 3:
                        image.src = 'img/geom/replica/office0/';
                        break;
                    case 4:
                        image.src = 'img/geom/replica/office1/';
                        break;
                    case 5:
                        image.src = 'img/geom/replica/office2/';
                        break;
                    case 6:
                        image.src = 'img/geom/replica/office3/';
                        break; 
                    case 7:
                        image.src = 'img/geom/replica/office4/';
                        break; 

                }
                switch (i) {
                    case 0:
                        image.src = image.src + 'rgb_gt.png';
                        break;
                    case 1:
                        image.src = image.src + 'rgb_pre.png';
                        break;
                    case 2:
                        image.src = image.src + 'depth_gt.png';
                        break;
                    case 3:
                        image.src = image.src + 'depth_pre.png';
                        break;
                    case 4:
                        image.src = image.src + 'normal_gt.png';
                        break;
                    case 5:
                        image.src = image.src + 'normal_pre.png';
                        break;
                }
            }

            let scene_list = document.getElementById("replica-geom").children;
            for (let i = 0; i < scene_list.length; i++) {
                if (idx == i) {
                    scene_list[i].children[0].className = "nav-link active"
                }
        ...
        function waymoSceneEvent(idx) {
            ...
            for (let i = 0; i < imagesLength; i++) {
                ...
                switch (idx) {
                    case 0:
                        image.src = 'img/waymo/106762/';
                        break;
                    case 1:
                        image.src = 'img/waymo/158686/';
                        break;
                    case 2:
                        image.src = 'img/waymo/405841/';
                        break; 
                }
                switch (i) {
                    case 0:
                        image.src = image.src + 'opengsslam.png';
                        break;
                    case 1:
                        image.src = image.src + 'ours.png';
                        break;
            ...
            let scene_list = document.getElementById("waymo").children;
            for (let i = 0; i < scene_list.length; i++) {
                if (idx == i) {
                    scene_list[i].children[0].className = "nav-link active"
                }
